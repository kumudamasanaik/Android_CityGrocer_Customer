...
class SocialLoginPresenter @Inject constructor(
        var apiService: ApiService,
        var context: Context,
        var baseScheduler: BaseScheduler) : SocialLoginContract.Presenter {

    var view: SocialLoginContract.View? = null
    private val subscription = CompositeDisposable()

    override fun takeView(view: SocialLoginContract.View?) {
        this.view = view
    }
