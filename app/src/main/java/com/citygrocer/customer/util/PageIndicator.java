...
public class PageIndicator extends View implements ViewPager.OnPageChangeListener,
    ...
    public PageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        dotDiameter = a.getDimensionPixelSize(R.styleable.PageIndicator_ipi_dotDiameter,
                DEFAULT_DOT_SIZE * density);
        dotRadius = dotDiameter / 2;
        halfDotRadius = dotRadius / 2;
        gap = a.getDimensionPixelSize(R.styleable.PageIndicator_ipi_dotGap,
                DEFAULT_GAP * density);
        animDuration = (long) a.getInteger(R.styleable.PageIndicator_ipi_animationDuration,
                DEFAULT_ANIM_DURATION);
        animHalfDuration = animDuration / 2;
        unselectedColour = a.getColor(R.styleable.PageIndicator_ipi_pageIndicatorColor,
                DEFAULT_UNSELECTED_COLOUR);
        selectedColour = a.getColor(R.styleable.PageIndicator_ipi_currentPageIndicatorColor,
